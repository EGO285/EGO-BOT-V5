...
const AIDE = {
    ...
    histoire: { usage: "!histoire [sous-commande]", description: "MODE HISTOIRE : un vrai RPG Naruto textuel persistant. Crée ton ninja OC (genin → légende), explore, fais des missions, combats au tour par tour (moteur déterministe + narration IA), progresse et sauvegarde. Nécessite une fiche Shinobi Storm. Tape !histoire aide pour tout voir.", exemple: "!histoire <ton pseudo>  ·  !histoire commencer <pseudo> clan=uchiha", category: "general" },
